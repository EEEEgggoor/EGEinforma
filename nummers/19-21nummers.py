...
#
# print('19)', [s for s in range(1, 37) if f(s, 2) and f(s, 1)==0])
# print('20)', [s for s in range(1, 37) if f(s, 3) and f(s, 1)==0])
# print('21)', [s for s in range(1, 37) if f(s, 4) and f(s, 2)==0])
...
#
#
# print('19)', [s for s in range(1, 25) if f(s, 2) and f(s, 1) == 0])
# print('20)', [s for s in range(1, 25) if f(s, 3) and f(s, 1) == 0])
# print('21)', [s for s in range(1, 25) if f(s, 4) and f(s, 2) == 0])
...
#          f(s1, s2 + 1, m - 1), f(s1, s2 * 3, m - 1)]
#     return any(h) if (m - 1) % 2 == 0 else all(h)
#
#
# print('19', [s for s in range(1, 63) if f(6, s, 2)])
# print('20', [s for s in range(1, 63) if f(6, s, 3) and not f(6, s, 1)])
# print('21', [s for s in range(1, 63) if f(6, s, 4)])
...
#     if m==0: return 0
#     h = [f(p1+(p2), p2, m-1), f(p1, p2+(p1), m-1)]
#     return any(h) if (m-1)%2==0 else all(h)
#
#
# print("20)", [p for p in range(1, 45) if f(6, p, 3) and not f(6, p, 1)])
# print("21)", [p for p in range(1, 6) if f(p, p, 4)])
